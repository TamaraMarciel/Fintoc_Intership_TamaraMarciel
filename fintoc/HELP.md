...
* [HTTP Client](https://docs.spring.io/spring-boot/4.0.1-SNAPSHOT/reference/io/rest-client.html#io.rest-client.restclient)
* [Reactive HTTP Client](https://docs.spring.io/spring-boot/4.0.1-SNAPSHOT/reference/io/rest-client.html#io.rest-client.webclient)
